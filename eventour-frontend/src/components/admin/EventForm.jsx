...
const EventForm = ({ onSave, eventoActual, setEventoActual }) => {
  ...
  useEffect(() => {
    if (eventoActual) setFormData(eventoActual);
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      ...formData,
      ubicacionId: formData.ubicacionId ? Number(formData.ubicacionId) : "",
    };
    onSave(payload);
  ...
  return (
    <form className="admin-form" onSubmit={handleSubmit}>
      ...
      <select name="categoriaEvento" value={formData.categoriaEvento}
              onChange={handleChange} required>
      ...
      <select name="ubicacionId" value={formData.ubicacionId}
              onChange={handleChange} required>
